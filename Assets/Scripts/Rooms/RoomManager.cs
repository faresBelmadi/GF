...
public class RoomManager : MonoBehaviour
{
    ...
    //    start.spriteToSet = _roomData.SalleStart;
    //    start.gameObject.transform.localScale = new Vector3(10, 10);
    //    start.roomType = TypeRoom.Spawn;
    //    start.SetLabel(TradManager.instance.GetTranslation(_roomData.SalleStartLabel));
    ...
    //    Rooms[1].spriteToSet = _roomData.SalleCombatNormal;
    //    Rooms[1].gameObject.transform.localScale = new Vector3(10, 10);
    //    Rooms[1].Type = TypeRoom.CombatNormal;
    //    Rooms[1].SetLabel(TradManager.instance.GetTranslation(_roomData.SalleCombatNormalLabel));
    ...
    //    Rooms[2].spriteToSet = _roomData.SalleLevelUp;
    //    Rooms[2].gameObject.transform.localScale = new Vector3(10, 10);
    //    Rooms[2].Type = TypeRoom.Autel;
    //    Rooms[2].SetLabel(TradManager.instance.GetTranslation(_roomData.SalleLevelUpLabel));

    //    Rooms[3].spriteToSet = _roomData.SalleCombatElite;
    //    Rooms[3].gameObject.transform.localScale = new Vector3(10, 10);
    //    Rooms[3].Type = TypeRoom.CombatElite;
    //    Rooms[3].SetLabel(TradManager.instance.GetTranslation(_roomData.SalleCombatEliteLabel));

    //    Rooms[4].spriteToSet = _roomData.SalleLevelUp;
    //    Rooms[4].gameObject.transform.localScale = new Vector3(10, 10);
    //    Rooms[4].Type = TypeRoom.Autel;
    //    Rooms[4].SetLabel(TradManager.instance.GetTranslation(_roomData.SalleLevelUpLabel));

    //    Rooms[5].spriteToSet = _roomData.SalleCombatNormal;
    //    Rooms[5].gameObject.transform.localScale = new Vector3(10, 10);
    //    Rooms[5].Type = TypeRoom.CombatNormal;
    //    Rooms[5].SetLabel(TradManager.instance.GetTranslation(_roomData.SalleCombatNormalLabel));

    //    Rooms[6].spriteToSet = _roomData.SalleLevelUp;
    //    Rooms[6].gameObject.transform.localScale = new Vector3(10, 10);
    //    Rooms[6].Type = TypeRoom.Autel;
    //    Rooms[6].SetLabel(TradManager.instance.GetTranslation(_roomData.SalleLevelUpLabel));

    //    Rooms[7].spriteToSet = _roomData.SalleCombatElite;
    //    Rooms[7].gameObject.transform.localScale = new Vector3(10, 10);
    //    Rooms[7].Type = TypeRoom.CombatElite;
    //    Rooms[7].SetLabel(TradManager.instance.GetTranslation(_roomData.SalleCombatEliteLabel));

    //    Rooms[8].spriteToSet = _roomData.SalleLevelUp;
    ...
    //    Rooms[9].spriteToSet = _roomData.SalleCombatBoss;
    ...
    //    Rooms[10].spriteToSet = _roomData.SalleEnd;
